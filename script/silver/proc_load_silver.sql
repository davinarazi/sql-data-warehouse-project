...
BEGIN
    ...
    BEGIN TRY
        ...
        SUBSTRING(prd_key, 7, LEN(prd_key)) as prd_key,        -- Exctract product key
        prd_nm,
        ...
        CASE 
            ...
            ELSE sls_sales
        END AS sls_sales, -- Recalculate sales if original value is missing or incorrect or null
        sls_quantity,
        CASE 
        ...
        SELECT
        REPLACE(cid, '-','') as cid, -- Remove '-' prefix
        CASE
        ...
        subcat,
        CASE 
            WHEN REPLACE(REPLACE(TRIM(maintenance), CHAR(13),''), CHAR(10), '') = '' OR maintenance IS NULL THEN 'n/a'
            ELSE REPLACE(REPLACE(TRIM(maintenance), CHAR(13),''), CHAR(10), '') 
        END as maintenance
